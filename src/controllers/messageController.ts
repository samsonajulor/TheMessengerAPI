...
export const createPrivateMessages = async (
  Expressreq: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    let { text } = req.body; //add the receiver's id to the body. The id must be someone you have added as a friend or favorite
    let details = [];
...
export const createGroupMessages = async (
  Expressreq: Request,
  res: Response,
  next: NextFunction
) => {
